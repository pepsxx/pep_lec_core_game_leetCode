...
public abstract class Motion {
    ...
    private static void motionRight() {
        int tmp = Main.mapsForCurrentRound.get(0)[0].length;
    ...
    private static void motionDown() {
        int tmp = Main.mapsForCurrentRound.get(0).length;
    ...
    private static void go(int nextHop1_x, int nextHop1_y, int nextHop2_x, int nextHop2_y) {
        Integer[][] mapCurTemp = Main.mapsForCurrentRound.get(0);
        Integer[][] mapGhoTemp = Main.mapsForCurrentRound.get(1);
