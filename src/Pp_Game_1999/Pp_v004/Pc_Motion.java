...
public abstract class Pc_Motion {
    ...
    public static int getPgi_mi_x() {
        return pgi_mi_x;
    }

    public static void setPgi_mi_x(int pgi_mi_x) {
        Pc_Motion.pgi_mi_x = pgi_mi_x;
    }

    public static int getPgi_mi_y() {
        return pgi_mi_y;
    }

    public static void setPgi_mi_y(int pgi_mi_y) {
        Pc_Motion.pgi_mi_y = pgi_mi_y;
    }

    public static int getPgi_nextHop1_x() {
        return pgi_nextHop1_x;
    }

    public static void setPgi_nextHop1_x(int pgi_nextHop1_x) {
        Pc_Motion.pgi_nextHop1_x = pgi_nextHop1_x;
    }

    public static int getPgi_nextHop1_y() {
        return pgi_nextHop1_y;
    }

    public static void setPgi_nextHop1_y(int pgi_nextHop1_y) {
        Pc_Motion.pgi_nextHop1_y = pgi_nextHop1_y;
    }

    public static int getPgi_nextHop2_x() {
        return pgi_nextHop2_x;
    }

    public static void setPgi_nextHop2_x(int pgi_nextHop2_x) {
        Pc_Motion.pgi_nextHop2_x = pgi_nextHop2_x;
    }

    public static int getPgi_nextHop2_y() {
        return pgi_nextHop2_y;
    }

    public static void setPgi_nextHop2_y(int pgi_nextHop2_y) {
        Pc_Motion.pgi_nextHop2_y = pgi_nextHop2_y;
    }
...
//            pgi_mi_x = pgi_nextHop1_x;
//            pgi_mi_y = pgi_nextHop1_y;
//        }  else if ((pmi_next1_value == 6 && (pmi_next2_value == 1 || pmi_next2_value == 9)) && ((pgi_nextHop1_x != pgi_nextHop2_x) || (pgi_nextHop1_y != pgi_nextHop2_y))) {
//            Pc_Main.setPgMMIn_map(pgi_mi_y,pgi_mi_x,pmi_mi_ghost_value);
//            Pc_Main.setPgMMIn_map(pgi_nextHop1_y,pgi_nextHop1_x,pmi_im_value);
//            Pc_Main.setPgMMIn_map(pgi_nextHop2_y,pgi_nextHop2_x,pmi_next1_value);
//            pgi_mi_x = pgi_nextHop1_x;
